...
func TestLoadDeploymentStrictProfile(t *testing.T) {
	...
	if deployment.ConnectorTCPPort != 26023 || deployment.ConnectorQUICPort != 26023 || deployment.PreviewBaseDomain != "preview.example.test" || deployment.HelperBaseDomain != "helper.example.test" || deployment.NodeCapacity != 128 {
