...
func TestLoadDeploymentStrictProfile(t *testing.T) {
	...
	if deployment.ConnectorTCPPort != 26022 || deployment.WildcardHost != "*.hexwagon.com" || deployment.NodeCapacity != 128 {
