...
func NewDataPlane(spec DataPlaneSpec) (*DataPlane, error) {
	if spec.Persistence == nil || spec.Control == nil || spec.Node == nil || spec.Routes == nil || spec.Gateway == nil || spec.Caddy == nil || spec.CaddyReady == nil || spec.Usage == nil {
...
func (d *DataPlane) Start(ctx context.Context) error {
	...
	components := []Component{d.spec.Persistence, d.spec.Gateway}
...
func (d *DataPlane) Shutdown(ctx context.Context) error {
	...
	order = append(order, d.spec.Node, d.spec.Control, d.spec.Gateway, d.spec.Persistence)
	var failures []error
