...
func TestMetadataResolverDecodesExactHandoff(t *testing.T) {
	raw := `{"operation_id":"op_admit_0001","credential":"credential-012345678901234567890123456789","environment_id":"env","helper_id":"helper","connector_generation":3,"edge_pool":"default","edge_node_id":"edge","routes":[{"route_id":"route","route_revision":2,"kind":"helper_https_wss","public_host":"helper.test","proxy_name":"proxy","target":{"host":"127.0.0.1","port":8080}}]}`
